    ...
    modulo.Init = function (config) {
        ...
        if (config) {
            ...
            if (config.containerId) {
                objectConfig.containerId = "#" + config.containerId;
                objectConfig.containerDefault = "#" + config.containerId;
            }
        }
        ...
        jQuery(objectConfig.containerId).append('<a href="#0" class="cd-top">Top</a>');
        ...
        jQuery(objectConfig.containerId).scroll(function () {
        ...
        $back_to_top.on('click', function (event) {
            ...
            jQuery(objectConfig.containerDefault).animate({
                scrollTop: 0
            }, scroll_top_duration
            );
        });
